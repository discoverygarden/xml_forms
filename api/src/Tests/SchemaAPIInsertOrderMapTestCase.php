...
/**
 * Unit tests for InsertOrderMap.inc
 *
 * @group xml_form_api
 */
class SchemaAPIInsertOrderMapTestCase extends \Drupal\simpletest\WebTestBase {
  ...
  public function test() {
    ...
    $order = $map->getOrder();
    $this->assertEqual($order, [], 'getOrder returns an empty array if no constaints were matched.');
